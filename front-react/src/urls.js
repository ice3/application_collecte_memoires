...
const GET_MEDIAS = `${BASE_URL}/memories/medias/`
...
export {BASE_URL, GET_QUESTIONS, GET_CONTRACT_CONFIG, NEW_MEMORY, GET_MEDIAS, build_SET_AUDIO_VIDEO, build_NEW_STREAM, build_SET_USER_INFOS, build_SET_USER_SIGNATURE, build_TERMINATE_MEMORY}